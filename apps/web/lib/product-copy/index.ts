export const productCopy = {
  ...
  avatars: {
    ...
    makingAvatarOptionsButton: "Making avatars...",
    makeNewButton: "Make 3 new avatars",
    makeAvatarOptionsButton: "Make avatar options",
  ...
  family: {
    ...
    musingNameFallback: "hoomin 1",
    musingNameLabel: "Name in musings",
    musingNamePlaceholder: "poppa, mooma...",
    musingNameSuggestions: ["poppa", "mooma", "hoomin 1"],
    editMusingNameLabel: (hoominName: string) =>
      `Edit how musings name ${hoominName}`,
    removeButton: "Remove",
