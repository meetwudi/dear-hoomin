...
Scheduled generation runs hourly and uses app-side `Intl` timezone support to find hoomins whose local time is at or past 6am, then generates each due pet for that local date.
