...
- `harness/product/incremental-alignments/2026-05-01-journal-thoughts.md`
...
- Multiple-pet family UX with pet archive/delete lifecycle.
- Automatic pet identification/classification from uploaded journal photos.
