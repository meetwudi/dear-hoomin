...
- Initial Supabase schema migration is drafted in `infra/supabase/migrations/202605010001_initial_schema.sql`.
- Consolidated schema and RLS overview is drafted in `infra/supabase/schema.md`.
